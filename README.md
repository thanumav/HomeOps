...
- `overwhelmed_day`: `0.9333`
- average final score: `0.9563`

## Run OpenAI-compatible baseline via Hugging Face
...
This runner uses the OpenAI Python client against Hugging Face’s OpenAI-compatible router.
